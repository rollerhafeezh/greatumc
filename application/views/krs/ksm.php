<table border="0" width="100%">
	<tr>
		<td width="1" style="text-align: right">
			<img src="<?= $_ENV['LOGO_100']; ?>" width="80">
		</td>
		<td>
			<center>
				<h2 class="p-0 m-0 nama-pt">UNIVERSITAS MUHAMMADIYAH CIREBON</h2>
				<h1 class="p-0 m-0 nama-fakultas"><?=$mahasiswa_pt->nama_fak?> - <?=$mahasiswa_pt->nama_prodi?></h1>
...
<table border="0" width="100%">
	<tr align="center">
		<td colspan="2"><h4>Validasi</h4></td>
	</tr>
	<tr align="center">
...
<table border="0" width="100%">
	<tr align="center">
		<td width="30%"><strong>Mahasiswa</strong></td>
		<td width="30%"><strong>Dosen Wali</strong></td>
