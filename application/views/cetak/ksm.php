...
<table border="0" width="100%">
	<tr>
		<td>
			<center>
				<h4 class="p-0 m-0 nama-pt">KARTU STUDI MAHASISWA</h4>
			</center>
		</td>
	</tr>
</table>
...
<table border="0" width="100%">
	<tr align="center">
		<td width="30%"><strong>Akademik</strong></td>
		<td width="30%"><strong>Keuangan</strong></td>
		<td><strong>Ketua Prodi</strong></td>
	</tr>
	<tr align="center">
		<td><?=$krs_note->tgl_validasi_aka?><br><strong><?=$krs_note->validasi_aka?></strong></td>
		<td><?=$krs_note->tgl_validasi_keu?><br><strong><?=$krs_note->validasi_keu?></strong></td>
		<td><?=$krs_note->tgl_validasi_prodi?><br><strong><?=$krs_note->validasi_prodi?></strong></td>
	</tr>
</table>
