...
<table border="0" width="100%" cellspacing="0" cellpadding="5">
    <tr>
        <td align="center"><h3>DAFTAR NILAI <?=strtoupper($jenis)?></h3></td>
    </tr>
    <tr>
...
<table border="1" width="100%" cellspacing="0" cellpadding="5">
    ...
    if($nilai)
    {
        ...
        {
            $nilai_ujian='';
            if($jenis=='uts') $nilai_ujian = $value->nilai_uts;
            if($jenis=='uas') $nilai_ujian = $value->nilai_uas;
            echo'
            <tr>
                <td align="center">'.$co.'</td>
                <td align="center">'.$value->id_mahasiswa_pt.'</td>
                <td>'.$value->nm_pd.'</td>
                <td align="center">'.$nilai_ujian.'</td>
            </tr>
            ';
