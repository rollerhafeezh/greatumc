...
<div class="row">
	...
	<div class="col-md-4 mt-2" id="pilih_gedung">
	...
	<div class="col-md-4 mt-2"  id="pilih_ruangan">
	...
	<div class="col-md-4 mt-2">
		<label for="selesai" class="form-label">Status</label>
...
$(document).ready(function() {
	var table = $('#datatabel').DataTable( {
		...
		responsive: true,
		dom: 	"<'row'<'col-sm-12 col-md-4 mb-1'l><'col-sm-12 col-md-4 mb-1'B><'col-sm-12 col-md-4 mb-1'i>>" +
	...
	$('#selesai').change(function(){ //button filter event click
        table.ajax.reload(null,false);  //just reload table
	});
