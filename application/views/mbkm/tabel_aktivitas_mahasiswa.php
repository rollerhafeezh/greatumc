							...
							<table id="datatabel" class="table table-striped" style="width:100%">
								<thead>
								    <tr>
								        ...
								        <th>Semester</th>
								        <th data-priority="3" class="text-nowrap">Skema Program</th>
								        <!-- <th class="text-nowrap">Judul Kegiatan</th> -->
								        <th class="text-nowrap">Lokasi Kegiatan</th>
    ...
    <div class="modal-content">
	  ...
	  <div class="modal-body">
	  	...
	  	<div class="row">
			...
			<div class="col-md-6 mb-2">
				...
				<select id="id_jenis_aktivitas_mahasiswa" name="id_jenis_aktivitas_mahasiswa" class="form-select">
					...
					<?php 
						...
						{
							if ($value->id_jenis_aktivitas_mahasiswa >= 13 AND $value->id_jenis_aktivitas_mahasiswa <= 21) {
			...
			<div class="col-md-6 mb-2">
				<label for="status_nilai_cpl" class="form-label">Status Nilai</label>
				<select id="status_nilai_cpl" name="status_nilai_cpl" class="form-select">
...
$(document).ready(function() {
	...
	var table = $('#datatabel').DataTable( {
		ajax: {
			url 	: "<?=base_url('mbkm/json_aktivitas_mahasiswa')?>",
			type 	: 'GET',
			data : function(d){
				...
				d.status = $("#status").val();
				d.status_nilai_cpl = $("#status_nilai_cpl").val();
			}
		},
		order: [[2, 'asc']],
		responsive: true,
	...
	$('#kode_fak, #kode_prodi, #id_smt, #id_jenis_aktivitas_mahasiswa, #status, #status_nilai_cpl').change(function(){ //button filter event click
        table.ajax.reload(null,false);  //just reload table
	});
