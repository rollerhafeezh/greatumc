			...
			<div class="col mb-4">
				<div class="card h-100">
					<div class="card-body d-flex flex-column">
						...
						<div class="alert alert-info"><i class="pli-information me-1"></i> Apabila status pendaftaran tidak berubah silahkan hubungi program studi.</div>
	...
	table = $('#datatabel').DataTable( {
		ajax: {
			...
			data : function(d) {
				...
				d.id_mahasiswa_pt = '<?= $_SESSION['id_user'] ?>'
			}
		},
		responsive: true,
		columnDefs: [
		...
		buttons: [
            ...
            // {
            //     text: '<i class="psi-tactic me-1"></i> Cari Program',
            //     className: 'btn btn-info',
            //     action: function ( e, dt, node, config ) {
            //         window.location.href = '<?= base_url('mbkm/cari_program') ?>'
            //     }
            // },
		],
		serverSide: true,
