	  	...
	  	<div class="row">
			...
			<div class="col-md-6 mb-2">
                ...
                <select class="form-select" id="id_program" name="id_program" required="" >
                    <option value="0">Pilih Skema Program</option>
...
$(document).ready(function() {
	...
	var table = $('#datatabel').DataTable( {
		ajax: {
			...
			data : function(d){
				...
				d.koordinator = '<?= $_SESSION['username'] ?>';
			}
		},
		order: [[2, 'asc']],
		responsive: true,
	...
	$('#kode_fak, #kode_prodi, #id_smt, #id_jenis_aktivitas_mahasiswa, #id_program').change(function(){ //button filter event click
        table.ajax.reload(null,false);  //just reload table
	});
